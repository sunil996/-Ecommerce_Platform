...
//Middleware for add_product request validation
...
async function addProduct(req:any,res:any){
  ...
  if (!req.files || Object.keys(req.files).length === 0) {
    ...
    const {product_name,product_image,product_category,product_price,product_quantity,product_description}=req.body;
    let data:any={seller_id,product_name,product_image,product_category,product_price,product_quantity,product_description};
